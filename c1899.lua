...
s.listed_names={1805, 1809}
function s.spfilter(c,code)
	local code1,code2=c:GetOriginalCodeRule()
	return code1==code or code2==code
end
function s.rescon(sg,e,tp,mg)
	return aux.ChkfMMZ(1)(sg,e,tp,mg) and sg:IsExists(s.chk,1,nil,sg,Group.CreateGroup(),1805,1809)
end
...
function s.spcon(e,c)
	...
	local g1=rg:Filter(s.spfilter,nil,1805)
	local g2=rg:Filter(s.spfilter,nil,1809)
	local g=g1:Clone()
	g:Merge(g2)
